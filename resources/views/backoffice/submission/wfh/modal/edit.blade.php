<div class="modal fade" id="edit-{{ $submission->id }}" tabindex="-1" aria-labelledby="examleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form role="form" method="POST" action="/backoffice/data-wfh/{{ $submission->id }}/update" enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('PUT')
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date"  name="start_date" class="form-control @if($errors->has('start_date')) is-invalid @endif" placeholder="Mulai wfh" value="{{ $submission->start_date }}"
                                required oninvalid="this.setCustomValidity('Mulai wfh harus diisi')" oninput="this.setCustomValidity('')" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="date"  name="end_date" class="form-control @if($errors->has('end_date')) is-invalid @endif" placeholder="Selesai wfh" value="{{ $submission->end_date }}"
                                required oninvalid="this.setCustomValidity('Selesai wfh harus diisi')" oninput="this.setCustomValidity('')" >
                            ...
                            <div class="form-group">
                                ...
                                required oninvalid="this.setCustomValidity('Alasan wfh harus diisi')" oninput="this.setCustomValidity('')">{{ $submission->description }}</textarea>
