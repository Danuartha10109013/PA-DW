            ...
            <div class="card card-outline card-primary">
                <div class="card-header" style="color: white">
                    ...
                    <div class="card-tools text-center">
                        ...
                        <button class="btn btn-info" data-toggle="modal" data-target="#edit-data-{{ $user->id }}" title="Ubah Data">
                            <i class="fa fa-edit"></i>
                        </button>

                        @include('backoffice.user-data.user.modal.edit-data')

                        <button class="btn btn-info" data-toggle="modal" data-target="#edit-password-{{ $user->id }}" title="Ubah Password">
